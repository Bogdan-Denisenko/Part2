...
public class ScheduleGenerator
{
    ...
    public String generateShips()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            date.set(Calendar.DAY_OF_MONTH, rnd(-7, 38));
            date.set(Calendar.HOUR_OF_DAY, rnd(0, 23));
            date.set(Calendar.MINUTE, rnd(0, 59));
            date.set(Calendar.SECOND, rnd(0, 59));
    ...
    public void addShipFromConsole()
    {
        ...
        date.set(Calendar.HOUR_OF_DAY, in.nextInt());
